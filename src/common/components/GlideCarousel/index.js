      ...
      {controls && (
        ...
        >
          <ButtonWrapper
            ...
            aria-label="prev"
          >
            {prevButton ? prevButton : <DefaultBtnLeft className='flaticon-next'></DefaultBtnLeft>}
          </ButtonWrapper>
          <ButtonWrapper
            {...nextWrapper}
            ...
            aria-label="next"
          >
            {nextButton ? nextButton : <DefaultBtnRight className='flaticon-next'></DefaultBtnRight>}
          </ButtonWrapper>
        </ButtonControlWrapper>
      )}
