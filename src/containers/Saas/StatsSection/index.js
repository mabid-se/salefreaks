...
import Illustration from 'common/assets/image/saas/illustration-temp.png';
    ...
    <Box {...sectionWrapper}>
      <Container>
        <Box {...sectionHeader}>
          <Heading
            {...sectionTitle}
            content="SaleFreaks Is One Of The Original Innovators In Dropshipping Tools Founded Over A Decade Ago - Having Evolved Into The Ultimate Side-Hustle Cheat Code Ever Since"
          />
        </Box>
        <Box {...row}>
          <Box {...col} {...imageArea}>
